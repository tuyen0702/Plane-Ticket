...
(
	...
	NGAYGIOGD DATETIME,
	HINHTHUCGD NVARCHAR(20),
	TINHTRANGGD NVARCHAR(20)
	CONSTRAINT PK_GIAODICH PRIMARY KEY(MAVE, MAKHACHHANG),
	CONSTRAINT FK_GIAODICH_KHACHHANG FOREIGN KEY(MAKHACHHANG) REFERENCES KHACHHANG(MAKHACHHANG),
	CONSTRAINT FK_GIAODICH_NHANVIEN FOREIGN KEY(MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN)
)
GO