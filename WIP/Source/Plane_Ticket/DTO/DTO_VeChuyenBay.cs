...
namespace DTO
{
    public class DTO_VeChuyenBay
    {
        ...
        public DTO_VeChuyenBay(string maVe, string maChuyenBay, string loaiGhe, int giaTien, string tinhTrang, DateTime ngayHuy)
        {
            this.MaVe = maVe;
        ...
        public string LoaiGhe { get => loaiGhe; set => loaiGhe = value; }
